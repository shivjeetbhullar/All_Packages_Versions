...
def render_comphis_url(SYS,fdate,tdate,series,dtype):
    return f"https://www1.nseindia.com/products/dynaContent/common/productsSymbolMapping.jsp?symbol={SYS}&segmentLink=3&symbolCount=2&series={series}&dateRange=+&fromDate={fdate}&toDate={tdate}&dataType={dtype.upper()}"
